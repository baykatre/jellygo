...
final class JellyfinAPI {
    ...
    func getItems(
        ...
        var queryItems: [URLQueryItem] = [
            ...
            URLQueryItem(name: "Fields", value: "Overview,PrimaryImageAspectRatio,UserData,RunTimeTicks,MediaStreams,MediaSources,Genres,OfficialRating,ImageTags,BackdropImageTags,PremiereDate,ProductionYear")
        ]
